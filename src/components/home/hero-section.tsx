    ...
    <section className="relative min-h-[870px] flex items-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-[1280px] mx-auto px-5 w-full">
        <div className="max-w-2xl fast-fade-in">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl font-bold leading-[0.9] mb-6 text-on-surface">
            Miami&apos;s Premium{" "}
          ...
          {/* Subheading */}
          <p className="text-lg text-on-surface-variant mb-10 max-w-xl font-body normal-case not-italic">
